...
VERSION = \
"""
MhsTinyCanDriver V0.60, 14.05.2015 (LGPL)
P.Menschel (menschel.p@posteo.de)
K.Demlehner (klaus@mhs-elektronik.de)
"""
from ctypes import Structure,c_char,c_int,c_uint8,c_int32,c_uint32,c_char_p,c_uint16,c_void_p,pointer,Union,POINTER,string_at,cast
import os
import sys
import time
import uselogging
...
class MhsTinyCanDriver:
    ...
    def OpenComplete(self, index = 0, options=None, snr=None, canSpeed=None, listenOnly=0):
        """
